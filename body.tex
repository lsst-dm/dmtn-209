...
Carried out by Rubin observatory on Cerro Pach\'{o}n Chile the survey will produce around 100 PB of data consisting of about a billion 16 Mpix images, enabling measurements for 40 billion objects! \cite{2019ApJ...873..111I}
...
The IDF will be used for a series of Data Previews (DP)\citep{RDO-011}. DP0 is using simulated data, DP1 commissioning camera data
and DP2 LSST Cam commissioning data. DP0 currently has two phases as outlined in Sections \ref{sec:dp01} and \ref {sec:dp02}\cite{RTN-001}.
